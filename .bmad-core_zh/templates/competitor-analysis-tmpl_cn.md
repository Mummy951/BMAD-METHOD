...
sections:
  - id: executive-summary
    title: 执行摘要
    instruction: 提供高层竞争洞察、主要威胁和机遇，以及建议的战略行动。在完成所有分析后最后编写本节。
  ...
  - id: competitive-landscape
    ...
    sections:
      ...
      - id: prioritization-matrix
        title: 竞争对手优先级矩阵
        instruction: |
          根据市场份额和战略威胁级别帮助分类竞争对手
          
          创建 2x2 矩阵：
          - 优先级 1（核心竞争对手）：高市场份额 + 高威胁
          - 优先级 2（新兴威胁）：低市场份额 + 高威胁
          - 优先级 3（老牌参与者）：高市场份额 + 低威胁
          - 优先级 4（仅监控）：低市场份额 + 低威胁

  - id: competitor-profiles
    title: 单个竞争对手资料
    instruction: 为每个优先级 1 和优先级 2 竞争对手创建详细资料。为优先级 3 和 4 创建精简资料。
    repeatable: true
    sections:
      - id: competitor
  ...
  - id: comparative-analysis
    ...
    sections:
      - id: feature-comparison
        title: 功能比较矩阵
        instruction: 创建关键功能在竞争对手之间的详细比较表
        type: table
        columns: ["功能类别", "{{your_company}}", "{{competitor_1}}", "{{competitor_2}}", "{{competitor_3}}"]
        rows:
          - category: "核心功能"
            items:
          ...
          - category: "用户体验"
            items:
              ...
              - ["入职时间", "{{time}}", "{{time}}", "{{time}}", "{{time}}"]
          - category: "集成与生态系统"
            items:
              - ["API 可用性", "{{availability}}", "{{availability}}", "{{availability}}", "{{availability}}"]
      ...
      - id: swot-comparison
        title: SWOT 比较
        instruction: 创建您的解决方案与主要竞争对手的 SWOT 分析
        sections:
          - id: your-solution
            title: 您的解决方案
            template: |
